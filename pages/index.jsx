  ...
  return (
    <div style={{ background: "#FAFCFF" }}>
            ...
            >
              ...
              <form className="d-flex">
                <Link href="/auth/login">
                  <a className="btn btn-outline-primary lp__btnn mx-3">Login</a>
                </Link>
          ...
          <div className="row">
            ...
            <div className="col-md-4 align-self-center lp__hero__center">
              <h1 className="lp__title">
                Awesome App For Saving <span className="lp__color">Time.</span>
              </h1>
              ...
              <div className="d-flex availabel">
                <img src="/image/gplay.png" className="lp__available" alt="" />
                <img
      ...
      <section id="Patner" className="mt-5">
        <div className="lp__bgBiru">
          <div className="container p-5">
            <img src="/image/patner.png" className="lp__patner w-100" alt="" />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-primary lp__footer">
        <div className="container p-5">
          <img src="/image/logo.png" className="mb-5 lp__footer__logo" alt="" />
